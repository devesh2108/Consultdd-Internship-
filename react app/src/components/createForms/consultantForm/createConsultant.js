...
import {
    addConsultant, getTeam, fetchGuestList,getCities
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Email: </label>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Current City: </label>
                                    ...
                                    <div className="col-md-6">
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Date of Birth </label>
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        ...
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Skill</label>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>SSN</label>
                                            <input
                                    ...
                                    <div className="col-md-6">
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Gender      </label>
                                            <Select
                                                style={{width: '100%'}}
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Skype ID      </label>
                                            <input
                                    ...
                                    <div className="col-md-6">
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Links      </label>
                                            <input
                                ...
                                <div className="row">
                                    <div className="col-md-6">
                                        <label><span style={{color: 'red', fontSize: 9}}>*</span>Work Type:      </label>
                                            <Select
                                                showSearch
                                                style={{width: '100%'}}
