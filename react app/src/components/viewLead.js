...
import {getAllVendorByCompany, getCities, getVendorCompanySuggestions, jdParser, updateLead} from "../services/service";
...
export default class ViewLead extends Component {
    ...
    componentDidMount() {
        ...
        if (this.props.leadDetails.skill !== null) {
            skillList.map((skill, index) => {
                    if (skill.value.toLowerCase() === this.props.leadDetails.skill.toLowerCase()) {
            ...
            <div>
                ...
                <div className="viewleadform">
                    ...
                    <Form layout='vertical'>
                        <div className="col-md-6 col-sm-6 col-xs-12">
                            <Form.Item label="Job Description">
                                <Button disabled={!this.state.disabled} className="parsebtn"
                                    ...
                                    <TextArea value={this.state.job_desc} onChnage={this.handleChange} name="job_desc" disabled={!this.state.disabled} style={{width: '100%'}} autosize={{minRows: 10, maxRows: 25}}/>
                            </Form.Item>
                            ...
                            <div style={{borderWidth: 1, borderColor: 'black'}}>
                                {skillList.map((tag, index) => {
                                    ...
                                    const tagElem = (
                                        <div  onClick={() => this.state.disabled ?this.onSelectSkill(tag.value, index):null}>
                                            <Tag
                                                style={{
                                                    width: '20%',
                                                    fontSize: 11,
                        ...
                        <div className="col-md-6 col-sm-6 col-md-12">
                            <div className="row">
                                <div className="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    >
                                            ...
                                            <Input onChange={this.handleChange} name="job_title" value={this.state.job_title} disabled={!this.state.disabled} style={{width: '100%'}}/>
