...
import EventDialog from "./addEvent";
import {getEvents, getInterviewee} from "../services/service";
...
class CalendarComponent extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            eventList: {},
            interview_id: 0,
            calendar_email: 'bbookingg@gmail.com',
            test_email: [],
    ...
    componentDidMount() {
        ...
        //this.getEvents(current_date, end_date);
    }
    ...
    render() {
        return (
                ...
                <div>
                    <div className="clalenderview" style={{flexDirection: 'row', padding: '10px', marginTop: '10px'}}>
                       
                        <div style={{flexDirection: 'column'}}>

                            <CalendarDatePicker startDate={new Date(this.state.startDate)} onOk={this.onDatePick}
                                                open={this.state.open}/>
                            <div className="calenderbox" style={{marginTop: 280}}>
                                ...
                                <div className="namebox2"></div>
                                <div className="namebox3"></div>
                                <div className="namebox4"></div>
                                <div className="namebox5"></div>
                                <div className="namebox6"></div>
                            </div>
                        </div>
                        ...
                        <div style={{marginTop: -360}}>
                            ...
                            >
                                <EventDialog
                                    ...
                                    submissionId={this.props.submissionId} handleClose={this.closeModal}
