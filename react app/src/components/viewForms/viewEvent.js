...
import {
    ...
    getInterviewByScreeningId,
    getInterviewByCalendarId,
    updateScreening
...
class Interview extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({
            ...
            start_date:
                startOfEST < new Date(this.props.interview_details.results.start_time) && new Date(this.props.interview_details.results.start_time) < endOfEST ?
                    moment(this.props.interview_details.results.start_time).add(4, 'hours').tz("America/Toronto"):
                    moment(this.props.interview_details.results.start_time).add(5, 'hours').tz("America/Toronto"),
            end_date:
                startOfEST < new Date(this.props.interview_details.results.end_time) && new Date(this.props.interview_details.results.end_time) < endOfEST ?
                    moment(this.props.interview_details.results.end_time).add(4, 'hours').tz("America/Toronto"):
                    moment(this.props.interview_details.results.end_time).add(5, 'hours').tz("America/Toronto"),
    ...
    editInterview() {
        ...
        updateScreening(this.props.interview_details.results.id, body, false, re)
            .then((response) => {
                                ...
                                <Form layout='vertical'>
                                    ...
                                    <div className="col-md-6 col-sm-6 col-xs-12">
                                        <Form.Item label="Type">
                                            ...
                                            <select disabled={this.state.disabled || !this.props.edit}
                                                    className="form-control" name="type" onChange={this.handleChange}
                                                    value={this.state.type}>
                                                <option value="telephonic">Telephone</option>
                                        ...
                                        <DateRangePicker tz={this.state.tz} create={this.props.create}
                                                         disabled={this.props.edit || this.state.disabled}
                                        ...
                                        <Form.Item label=" Dialing Details">
                                            ...
                                            <Input disabled={this.state.disabled || !this.props.edit}
                                        ...
                                        <Form.Item label="Attachment Link">
                                            ...
                                            <Input disabled={this.state.disabled || !this.props.edit}
                                                   onChange={this.handleChange} style={{width: '100%'}} name="link"
                                    ...
                                    <div className="inviewbutton">
                                        ...
                                        <Button disabled={this.state.disabled}
                                                onClick={this.editInterview}>Submit</Button>
                                    </div>
